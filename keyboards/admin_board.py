...
admin_board = ReplyKeyboardMarkup(resize_keyboard=True).row(statistics, add_paymethod).row(add_admin).row(withdraw_btc, withdraw_usdt, withdraw_xmr).row(cancel)
